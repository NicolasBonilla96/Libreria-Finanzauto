<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_Users.aspx.cs"
    MasterPageFile="~/AppWebForms/Default.master" Inherits="ApplicationWebForms.AppWebForms.Frm_Users" %>
...
<asp:Content ID="contentUser" ContentPlaceHolderID="contentMaster" runat="server">
    <table style="margin:auto; padding-top:2%">
        <tr>
            ...
            <td style="padding-left: 15px">
                <asp:Label ID="lblName" runat="server" Text="Nombre del Usuario">
                </asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lblEmail" runat="server" Text="Email del Usuario">
                </asp:Label>
            </td>
            <td>
    ...
    <table style="padding-top:1%">
        <asp:GridView ID="gvUsers" runat="server" AllowPaging="true" PageSize="5" CellPadding="3"
            OnRowCommand="gvUsers_Row" Visible="false" AutoGenerateColumns="False" style="margin: auto" Width="50%">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Nombre del Usuario">
                    <ItemTemplate>
                        <asp:Label CausesValidation="false" ID="lblNameGv" runat="server"
                            Font-Underline="True" Font-Bold="True" Text='<%# Eval("name") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Email del Usuario">
                    <ItemTemplate>
                    <asp:Label CausesValidation="false" ID="lblEmailGv" runat="server"
                        Font-Underline="True" Font-Bold="True" Text='<%# Eval("email") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
